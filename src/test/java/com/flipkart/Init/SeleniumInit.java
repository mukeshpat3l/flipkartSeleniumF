...
import com.flipkart.Scenario1.IndexPageSc1;
import com.flipkart.Scenario1.VerificationSc1;
...
public class SeleniumInit{
    ...
    //Search
    protected IndexPageSc1 indexPageSc1;
    protected VerificationSc1 verificationSc1;
	...
	public void setUp(Method method, ITestContext testContext,ITestResult testResult) throws IOException, InterruptedException 
	{
		...
		testEmail = TestData.getValueFromConfig("config.properties","UserName");
		testPswd = TestData.getValueFromConfig("config.properties","PassWord");
		...
		// Search
		indexPageSc1 = new IndexPageSc1(driver);
		verificationSc1 = new VerificationSc1(driver);
