...
public class Common {
	...
	public static int returnDays(String WeekDay) {
		int day = 0;
		switch (WeekDay) {
		case "Saturday":
			day = 1;
	...
	public static int returnDays1(String WeekDay) {
		int day = 0;
		switch (WeekDay) {
		case "Saturday":
			day = 6;
	...
	public static String email() throws FileNotFoundException {
		...
		String content = new Scanner(new File("E://Projects//IRF//test-output//CustomReporterTestFailureDetails.html")).useDelimiter("\\Z").next();
		return content;
	}
	...
	public static void sendFaiulreReport(String s) throws EmailException {
		try {
			...
			email.setTextMsg("</br> Please Find Test Failure Report.");
			
			email.setHtmlMsg(Common.email());
			
			email.addTo("mukeshptl002@gmail.com");
